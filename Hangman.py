...
pg.display.set_caption("Hangman+ by Aarthif")
...
wordsTR = ["ISTANBUL","IZMIR","ANKARA","MALATYA","ANTALYA","ESKISEHIR","MUGLA","HATAY","BURSA",
         "AARTHIF","NAWAZ","BATUHAN","GURBUZ","AYSE","CEVAT","DENIZ","CENGIZ",
...
wordsEN = ["NEW YORK", "WASHINGTON","LAS VEGAS", "CALIFORNIA","TEXAS","MEXICO","LONDON","MANCHESTER","BRIGHTON",
           ...
           "AARTHIF","HAMDAN","FIRAZ","NAWAZ","AASIF","WSO2","INTERNET","GAMING CONSOLE","PLAYSTATION",
           ...
           "MACHINE LEARNING","HIGHSCHOOL","UNIVERSITY OF WESTMINSTER","OXFORD UNIVERSITY","CAMBRIDGE UNIVERSITY","COMPUTER SCIENCE",
